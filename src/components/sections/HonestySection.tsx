...
export default function HonestySection() {
  return (
    <section aria-labelledby="honesty-heading" className="text-white py-16 lg:py-24">
      <div className="max-w-6xl mx-auto px-4">
        <h2 id="honesty-heading" className="font-heading font-semibold text-2xl md:text-4xl text-center mb-12">
          Ce que je ne ferai pas
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {items.map((item) => (
            <div key={item} className="bg-surface border border-border rounded-2xl p-6">
